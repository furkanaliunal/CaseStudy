...
public class TeleportManager {
     ...
     * @return true if request is added to list, false if request is not added to list.
     */
     ...
     * @param player - player who is sending teleportation request.
     * @param targetPlayer - player who is receiving teleportation request.
     * @return true if player has already sent pending teleportation request to other player, false if player has not sent pending teleportation request to other player.
     */
     ...
     * @param teleportation - pending teleportation request to remove.
     */
     ...
     * @param teleportation - pending teleportation request to cancel.
     */
     ...
     * @param player - player who is sending teleportation request.
     * @return pending teleportation request of player from list.
     */
     ...
     * @param player - player who is sending teleportation request.
     * @param targetPlayer - player who is receiving teleportation request.
     * @return pending teleportation request of player to a target player from list.
     */
